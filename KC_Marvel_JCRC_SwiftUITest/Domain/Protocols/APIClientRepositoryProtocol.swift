...
final class APIClientRepositoryFakeSuccessProtocol: APIClientRepositoryProtocol {
...
final class APIClientRepositoryFakeErrorProtocol: APIClientRepositoryProtocol {
    func getCharacter(by characterName: String, apiRouter: APIRouter) async throws -> Character {
...
final class APIClientRepositoryTests: XCTestCase {
    
    // MARK: - Test de Éxito: getCharacter
    
    func testGetCharacterSuccess() async throws {
        // Arrange
        let repository = APIClientRepositoryFakeSuccessProtocol()
    ...
    func testGetCharacterError() async throws {
        // Arrange
        let repository = APIClientRepositoryFakeErrorProtocol()
